...
This repository is adapted from [Karl-Ludwig Besser's template](https://www.overleaf.com/latex/templates/review-response-template/tmbvmjstxwrd), which provides a simple LaTeX template for writing responses to reviewers. You may preview the PDF file [here](https://github.com/withhaotian/Journal-Response-Letter-Template-Latex/blob/main/Review_Response_Template.pdf)
